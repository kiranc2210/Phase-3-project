...
<body>
	...
	${error}
	<form name=frmReg action="signup" method="post">
		<div class="container">
			<h1>Register</h1>
			...
			<label for="email"><b>Email</b></label> <input type="text"
				placeholder="Enter Email" name="email_id" id="email" required>
			...
			<label for="psw"><b>Password</b></label> <input type="password"
				...
				id="psw-repeat" required> <label for="psw-repeat"><b>Last
					name*</b></label> <input type="text" placeholder="Last name" name="lname"
				id="psw-repeat" required> <label for="psw-repeat"><b>Age*</b></label>
			<input type="text" placeholder="Age" name="age" id="psw-repeat"
				required> <label for="psw-repeat"><b>Address</b></label> <input
				type="text" placeholder="Address" name="address" id="psw-repeat"
				required>
			<hr>
			<p>
